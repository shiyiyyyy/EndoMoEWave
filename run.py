...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-path',default="./vision_quality/image_test/", type=str)
    parser.add_argument('--img-height', type=int, default=476)
    parser.add_argument('--img-width', type=int, default=588)
    parser.add_argument('--outdir', type=str, default='./vision_testbf/edge')

    parser.add_argument('--encoder', type=str, default='vits', choices=['vits', 'vitb', 'vitl', 'vitg'])
    parser.add_argument('--load-from', type=str, default="./yzp/c3vd/los_rmse/0.1edge/latest_model.pth")
    ...
    for k, filename in enumerate(filenames):
        ...
        # 保存与GT同尺度的灰度图
        # depth_gray = (depth * 2.55).clip(0, 255).astype(np.uint8)
        # gray_path = os.path.join(args.outdir, os.path.splitext(os.path.basename(filename))[0] + '_gray.png')
